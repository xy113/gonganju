...
<h2><?php echo $lang['article_category']?></h2>

<ul class="tab">

<li><a href="<?php echo $BASESCRIPT?>?action=articlecat"><span><?php echo $lang['manage']?></span></a></li>

<li class="current"><a href="<?php echo $BASESCRIPT?>?action=articlecat&operation=edit&cid=<?php echo $cid?>"><span><?php echo $lang['edit']?></span></a></li>
...
<div class="wrapper">
  ...
  <form name="form1" method="post" action="<?php echo $BASESCRIPT?>?action=articlecat&operation=edit">
...
<div class="wrapper">
  ...
  <form name="articlecat" method="post" action="<?php echo $BASESCRIPT?>?action=articlecat">
...
<input type="hidden" name="formhash" value="<?php echo FORMHASH?>">
  ...
  <tr onMouseOver="$(this).addClass('hover')" onMouseOut="$(this).removeClass('hover')">
        ...
        <td><a href="<?php echo $BASESCRIPT?>?action=articlecat&operation=edit&cid=<?php echo $cat['cid']?>"><?php echo $lang['edit']?></a> <a href="<?php echo $BASESCRIPT?>?action=articlecat&operation=delete&cid=<?php echo $cat['cid']?>"><?php echo $lang['del']?></a></td>
  ...
  <tr onMouseOver="$(this).addClass('hover')" onMouseOut="$(this).removeClass('hover')">
        ...
        <td><a href="<?php echo $BASESCRIPT?>?action=articlecat&operation=edit&cid=<?php echo $sub['cid']?>"><?php echo $lang['edit']?></a> <a href="<?php echo $BASESCRIPT?>?action=articlecat&operation=delete&cid=<?php echo $cat['cid']?>"><?php echo $lang['del']?></a></td>
