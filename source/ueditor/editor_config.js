...
(function () {
	...
	var burl = url1[0]+'//'+url2[0];
	window.UEDITOR_HOME_URL = burl+"/source/ueditor/";
    var URL;
    /**
    ...
    var tmp = window.location.pathname;
        ...
        URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("source/ueditor/","").replace("ueditor/","");
